...
jQuery.validator.addMethod("schedule_alarm_interval", function(value, element) {
	var  schedule_alarm_interval = $('#schedule_alarm_interval').val();
	var schedule_alarm_recurring = $('#schedule_alarm_recurring').val();
	 if(Number(schedule_alarm_recurring) > 1) {	   
	     if(300 < Number(schedule_alarm_interval)) {
	    	 return false;
	     } else if(Number(schedule_alarm_interval) < 1) {
	    	 return false;
	     } else{
	    	 return true;
	     }		
...
jQuery.validator.addMethod("schedule_alarm_interval1", function(value, element) {
	var  schedule_alarm_interval = $('#schedule_alarm_interval1').val();
	var schedule_alarm_recurring = $('#schedule_alarm_recurring1').val();
	 if(Number(schedule_alarm_recurring) > 1) {	   
	     if (300 < Number(schedule_alarm_interval)) {
	    	 return false;
	     } else if(Number(schedule_alarm_interval) < 1) {
